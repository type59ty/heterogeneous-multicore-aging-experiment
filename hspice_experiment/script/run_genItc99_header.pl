#! /usr/bin/perl
# Proram: run_genItc99_header
# Author: Kun-Wei Chiu
# Last Update: 2017/04/18
# Objective: generate a SPICE netlist with pmos sleep transistors inserted
# example:
#(1) general sim.: 1) remove the # of line26  2)$./run_genItc99_header
#(2) aging sim.: $./run_genItc99_header 32nm_bulk_0m.pm
...
my $task = $ARGV[6];
my $benchmark_sp_dir = "benchmark/itc99_sp";
...
my $cell_lib = "benchmark/itc99_lib_sp/itc99_lib.sp"; # the subcell library (.sp file) of bencmark case
...
# 7) attach analysis
attach_analysis($filehandle, $st_num, $iteration, $interval, $time_unit, $input_vec_length, $supply, $trans_input_vec_file_name, $trans_output_vec_file_name, $benchmark_name);
print OUT_FH ".end\n";
close OUT_FH;
